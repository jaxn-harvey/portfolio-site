...
2. **Remove** any existing default **A** records Wix added for `@`
   (root/apex) pointing at Wix's own servers — otherwise they'll conflict.
...
a green checkmark, turn on **Enforce HTTPS** in the Pages settings.
